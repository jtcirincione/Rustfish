...
pub fn generate_pseudo_moves(my_pawns: u64, enemy: u64, occupied: u64, white: bool) -> u64 {
    ...
    if white {
        ...
        double_push = (push << 8) & !occupied & WHITE_2MOVE_ROW;
        left_attacks = my_pawns << 9 & FILE_H_MASK & enemy;
        right_attacks = my_pawns << 7 & FILE_A_MASK & enemy;
        ...
        push = (my_pawns >> 8) & !occupied;
        double_push = (push >> 8) & !occupied & BLACK_2MOVE_ROW;
        left_attacks = my_pawns >> 7 & FILE_H_MASK & enemy;
        right_attacks = my_pawns >> 9 & FILE_A_MASK & enemy;
